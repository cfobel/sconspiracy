...
class DoxygenError(yams.YamsProjectError):
    pass

DOXYGEN_PLUGIN_PATH = os.path.dirname(__file__)

class DoxygenProject(ConstructibleYamsProject):
    doxygen_dir    = 'Dox'
...
#        env.Depends(result, sources)
    ...
    def install_path(self):
        install_dir = yams.yenv.dirs.install_doc
        return install_dir
