...
class register(object):
    ...
    def __call__(self, cls, src=None):
        ...
        for name in cls.register_names:
            name = name.lower()
            if not isinstance(cls.version, yams.yutils.Version):
                cls.version = yams.yutils.Version(cls.version)
            version = cls.version
            ...
            if nv in self.libs[name]:
                ...
                yams.print_warning("Overrided libext", msg)
    ...
    if hasattr(lib, '__iter__'):
        ...
        if libname in register.libs:
            ...
            if version != binpkg_versions.setdefault(libname,version):
                ...
                raise yams.LibExtException, msg.format(libext=libname, prj=prj,
            ...
            raise yams.LibExtException, msg.format(libext=lib,prj=prj)
